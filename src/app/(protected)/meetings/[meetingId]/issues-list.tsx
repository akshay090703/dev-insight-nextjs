            ...
            <div className="p-8">
                <div className="mx-auto flex max-w-2xl items-center justify-between gap-x-8 border-b pb-6 lg:mx-0 lg:max-w-none">
                    <div className="flex items-center gap-x-6">
                        <div className="rounded-ful border p-3">
                        ...
                        <h1>
                            ...
                            <div className="mt-1 text-base font-semibold leading-6 text-gray-900 dark:text-gray-400">
                                {meeting.name}
                            </div>
                        </h1>
                    </div>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <blockquote className="mt-2 border-l-4 border-gray-300 bg-gray-50 dark:border-gray-800 dark:bg-black p-4 text-gray-800 dark:text-gray-400 rounded-md">
