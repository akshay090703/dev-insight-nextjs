  ...
  (async () => {
    const { textStream } = await streamText({
      ...
      prompt: `
            ...
            Answer in markdown syntax and not html syntax, with code snippets if needed. Be as detailed as possible when answering, make sure there is no information outside of the context. 
        `,
    });
